<?php include_once 'includes/templates/header.php'; ?>
  ...
  <section class="seccion contenedor">
       ...
       <div class="galeria">
            <a href="img/galeria/01.jpg" data-lightbox="galeria"> <!-- // data-lightbox conecta html con js; no hay método en lightbox-->
                 <img src="img/galeria/thumbs/01.jpg"> <!--// imagen en miniatura-->
            </a>
