              ...
              <section class="content">
               ...
               <div class="box">
                  ...
                  <div class="box-body">
                       ...
                       <!-- form start -->
                       <form role="form" method="post" action="modelo-invitado.php" id="guardar-registro-archivo" name="guardar-registro" enctype="multipart/form-data">
                       <div class="box-body">
                           ...
                           <div class="form-group">
                             ...
                             <input type="file" class="form-control" id="imagen_invitado" name="archivo_imagen" value="<?php echo $invitado['url_imagen']; ?>>
