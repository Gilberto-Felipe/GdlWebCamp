              ...
              <table id="registros" class="table table-bordered table-striped">
                ...
                <tbody>
                     ...
                     <?php
                         ...
                         // generar la tabla dinámicamente con while php
                         while (  $eventos = $resultado->fetch_assoc() ) { ?>
                              <tr>
                                   ...
                                   <td>
                                        ...
                                        <a href="#" data-id="<?php echo $eventos['evento_id'] ?>" data-tipo="evento" class="btn bg-maroon btn-flat margin borrar-registro">
