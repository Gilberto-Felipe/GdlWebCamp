        ...
        <div class="programa-evento">
          ...
          <?php // query en php
               try { // try/catch +- if/else
                    ...
                    $sql .= " ORDER BY evento_id LIMIT 2;"; // limit 2 porque en nuestro diseño solo mostramos 2. Siempre al finalizar una consulta ;";
                    $sql .= " SELECT evento_id, nombre_evento, fecha_evento, hora_evento, cat_evento, icono, nombre_invitado, apellido_invitado ";
                    $sql .= " FROM eventos ";
                    $sql .= " INNER JOIN categoria_evento ";
                    $sql .= " ON eventos.id_cat_evento = categoria_evento.id_categoria ";
                    ...
                    $sql .= " ORDER BY evento_id LIMIT 2;"; // limit 2 porque en nuestro diseño solo mostramos 2
               } catch (\Exception $e) {
                    echo $e->getMessage();
               }
          ?>
          ...
          <?php
               do {
                    ...
                    <?php $i = 0; ?>
                    <?php foreach ($resultado as $evento): ?>
                         <?php if($i % 2 == 0) { ?>
                         ...
                         <?php $i++; ?>
                    <?php endforeach; ?>
                    <?php $resultado->free(); // con multiquerys se debe liberar la consulta ?>
